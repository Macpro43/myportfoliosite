      ...
      <Link to="/">
        ...
        <div className="project-header">
          ...
          <div className="project-blurb">
            ...
            foreclosure properties. It reached the ten-year anniversary of
            auction.com; what better than to celebrate with a company rebrand?
            It was about six years since any significant brand design changes
            were implemented.
        ...
        <div className="the-problem">
          <div className="problemBlurb">
            ...
            <ol type="1">
              ...
              <li>
                Our existing style guide was limited, difficult to use and was
                not consistently implemented into the products.
              </li>
            </ol>
            ...
            <p>
              To kick this initiative off the product team held a design
              workshop with the marketing team. From there the agenda was:
            </p>
        ...
        <div className="sectionBlurb">
          ...
          <p>
            First-time visitors may not immediately understand what Auction.com
            is, and this confusion may prevent them from engaging with our site.
            Introducing meaningful content may give them reasons to trust ADC
        ...
        <div className="sectionBlurb">
          ...
          <p>
            80% of the user testing felt more positive towards the searched
            optimized homepage.
          </p>
        </div>
        ...
        <div className="sectionBlurb">
          ...
          <H3>The Problem</H3>
          <ol type="1">
            <li>Inconsistent nomenclature</li>
        ...
        <div className="sectionBlurb">
          <H2>What we did:</H2>
          <p>
            We updated the iOS & Android style sheets to have consistent colors,
            components, and type treatment.
          </p>
          <p>
            Started creating a timeline for updating the nomenclature tone &
            voice.
          </p>
          <p>Developers started updating the code base.</p>
        </div>
        <div className="content-space-80px"></div>
        <div className="content-space-80px"></div>
        <SectionTitle>
        ...
        <div className="sectionBlurb">
          ...
          <p>The heart of all our products was the style guide. Our style guide needed a complete revamp of the visual product components and functionality.</p>
...
<div className="sectionBlurb">
          ...
          <p>Breaking all the components among the designers for weekly sync-ups to quickly update the style guide and developer toolkit.</p>
